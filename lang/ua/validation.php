...
return [
    ...
    */
	...
	'accepted_if' => 'Атрибут :attribute повинен бути прийнятий, якщо :other є :value.',
	...
	'required' => 'Поле :attribute має бути обов\'язковим.',
	'required_array_keys' => 'Поле :attribute має містити записи для: :values.',
	'required_if' => 'Поле :attribute має бути обов\'язковим, якщо :other є :value.',
	'required_unless' => 'Поле :attribute має бути обов\'язковим, якщо :other не міститься в :values.',
	'required_with' => 'Поле :attribute має бути обов\'язковим, якщо присутній :values.',
	'required_with_all' => 'Поле :attribute має бути обов\'язковим, якщо присутні :values.',
	'required_without' => 'Поле :attribute має бути обов\'язковим, якщо немає :values.',
	'required_without_all' => 'Поле :attribute має бути обов\'язковим, якщо немає жодного з :values.',
	...
	'starts_with' => 'Поле :attribute повинно починатися з наступного: :values.',
